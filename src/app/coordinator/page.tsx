    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {projects.map(project => {
          ...
          const delayed = visibleStages.filter(s => s.stage_status === 'delayed').length
          ...
          return (
            ...
            >
              ...
              <div className="mb-2">
                ...
                <p className="text-xs text-gray-400 mt-1">{done}/{total} stages done{delayed > 0 ? ` · ${delayed} delayed` : ''}</p>
              </div>
