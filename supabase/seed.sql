...
insert into stage_targets (stage_name, target_days, buffer_days, category, sort_order) values
  ...
  ('Grills & Frames',    210,  7, 'finishing', 13),
  ('Electrical 1',       220,  7, 'finishing', 14),
  ('Plumbing 1',         230,  7, 'finishing', 15),
  ('Plastering Int',     240,  7, 'finishing', 16),
  ('Flooring Procurement',250, 7, 'finishing', 17),
  ('Flooring Laying',    260,  7, 'finishing', 18),
  ('Plastering Ext',     270,  7, 'finishing', 19),
  ('Electrical 2',       280,  7, 'finishing', 20),
  ('Painting 1',         290,  7, 'finishing', 21),
  ('Plumbing Fixtures',  300,  7, 'finishing', 22),
  ('Railings',           310,  7, 'finishing', 23),
  ('Doors & Windows',    320,  7, 'finishing', 24),
  ('Painting 2',         330,  7, 'finishing', 25),
  ('Handover',           365,  7, 'finishing', 26)
